"""
Production Django settings for {{ project_name }} project.

Generate SECRET_KEY_PRODUCTION on CLI:
...
# Security
# Environment variable suffixed with "PRODUCTION" to prevent a mix-up.
